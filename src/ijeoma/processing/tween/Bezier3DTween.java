...
public class Bezier3DTween extends Motion { // implements Comparable {
	...
	public Bezier3DTween(String _name, Bezier3D _path, float _begin, float _end, float _duration, float _delay, String _easing) {
		super(_name, _begin, _end, _duration, _delay, _easing);
		setupBezier(_path);
	}
	
	public Bezier3DTween(String _name, Bezier3D _path, float _begin, float _end, float _duration, float _delay) {
		super(_name, _begin, _end, _duration, _delay);
		setupBezier(_path);
	}
	
	public Bezier3DTween(String _name, Bezier3D _path, float _begin, float _end, float _duration) {
	...
	protected void setupEvents() {
		...
		try {
			tweenBezierStartedMethod = parentClass.getMethod(MotionEvent.TWEEN_STARTED, new Class[] { Bezier3DTween.class });
		} catch (Exception e) {
		}

		try {
			tweenBezierEndedMethod = parentClass.getMethod(MotionEvent.TWEEN_ENDED, new Class[] { Bezier3DTween.class });
		} catch (Exception e) {
		}

		try {
			tweenBezierChangedMethod = parentClass.getMethod(MotionEvent.TWEEN_CHANGED, new Class[] { Bezier3DTween.class });
		} catch (Exception e) {
		}

		try {
			tweenBezierRepeatedMethod = parentClass.getMethod(MotionEvent.TWEEN_REPEATED, new Class[] { Bezier3DTween.class });
		} catch (Exception e) {
		}
	}
